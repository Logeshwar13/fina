-- Create insurance_policies table (with TEXT user_id to match existing users table)
...
-- Create insurance_risk_assessments table (with TEXT user_id to match existing users table)
